...
<span ng-init="pre({{$userdat->id}})">
                        ...
                        <a href="#" ng-show="if7" ng-click="blockuser({{$userdat->id}})">
                            block {{--<span class="livicon" data-name="mail"  data-size="20" id="livicon-3"
                                  style="width: 20px; height: 20px;">
                            </span>--}}
                        </a> <a style="color:red" href="#" ng-hide="if7" ng-click="unblockuser({{$userdat->id}})">
                            unblock {{--<span class="livicon" data-name="mail"  data-size="20" id="livicon-3"
                                  style="width: 20px; height: 20px;">
                            </span>--}}
                        </a>
                    ...
                    <div class="col-xs-12 col-md-9">
                        <h2>Hi, i am <span>{{$item->first_name}}!</span></h2>
                        <h3>{{$item->profession}}</h3>
                        <p><strong>{{$item->headline}}</strong>.{{$item->aboutme}}

                    </div><!--column-->
                </div><!--row-->
                <div class="row">
                <div class="col-md-12 col-xs-12" ng-show="messagebox">
                    <form ng-submit="messagebody({{$userdat->id}})">
                        <h4>Send message !</h4>
