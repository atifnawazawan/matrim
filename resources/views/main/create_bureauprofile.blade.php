        ...
        <div class="container">
            <div class="breadcrumb1">
                <ul>
                    ...
                    <span class="divider">&nbsp;|&nbsp;profile</span>
                </ul>
            </div>
            ...
            <div class="services">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{ url('/bureauprofile') }}" >
                    {{ csrf_field() }}
                    ...
                    <div class=" col-xs-12 col-sm-8">
                        <div class="jumbotron">
                            ...
                            <div class="grabr-input grabr-input-images">
                                <span>Bureau’s picture (at least one picture is required)</span>
                                <p data-ng-show="pic" style="color:red;">Bureau can upload one picture
                                </p><br>
                           ...
                           <input type="text" name="name" value="{{old('name')}}" id="profile-name" placeholder="enter bureau name">
                            @if ($errors->has('name'))
                            ...
                            <input type="text"  name="address"  id="profile-address" value="{{old('address')}}" placeholder="enter your address">
